        ...
        <div className="space-y-8">
          <div className="text-center space-y-6">
            ...
            <p className="text-gray-300 text-base leading-relaxed font-light">
              hello all i got fun things for a day... like a fun p.r0xy? none of these links were made by me, if there are any problems or have any suggestions for sites/movies dm me on discord @vrhd
            </p>
          </div>
